const ARTICLE_NAME = "linguistics-intro"
const ARTICLE_NAME_UNDERSCORE = "linguistics_intro"
const ARTICLE_TITLE = "Linguistics Intro"
const ARTICLE_DESCRIPTION = "Phonemes and graphemes - the sounds and spellings of English"
const ARTICLE_PUBLISH_TIME = "2021/09/09"
